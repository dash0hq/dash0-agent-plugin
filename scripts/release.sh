...
sed -i '' "s/\$Version = '[^']*'/\$Version = '${VERSION}'/" cursor/cursor-on-event.ps1
...
grep 'Version = ' cursor/cursor-on-event.ps1

git add .claude-plugin/plugin.json .cursor-plugin/plugin.json .codex-plugin/plugin.json copilot/plugin.json .github/plugin/marketplace.json claude/claude-on-event.sh cursor/cursor-on-event.sh codex/codex-on-event.sh copilot/copilot-on-event.sh copilot/copilot-on-event.ps1 codex/codex-on-event.ps1 cursor/cursor-on-event.ps1
