...
|---|---|---|
| `claude/` (`claude-on-event.sh`, `commands/`, `skills/`), `.claude-plugin/`, `hooks/hooks.json` | Claude Code | Bootstrap wrapper, slash commands, configure skill, manifest, hook registration |
