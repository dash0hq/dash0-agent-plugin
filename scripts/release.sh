...
git add .claude-plugin/plugin.json .cursor-plugin/plugin.json .codex-plugin/plugin.json scripts/on-event.sh scripts/cursor-on-event.sh scripts/codex-on-event.sh
